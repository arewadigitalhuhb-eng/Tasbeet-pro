...
const TRANSLATIONS = {
    en: {
        appTitle: 'Tasbeeh Pro',
        splashSubtitle: 'Digital Dhikr Companion',
        ...
        chooseDhikr: 'Choose a dhikr to begin your session',
        statistics: 'Statistics',
        trackProgress: 'Track your spiritual progress',
        today: 'Today',
        thisWeek: 'This Week',
        streak: 'Streak',
        total: 'Total',
        ...
        counter: 'Counter',
        sound: 'Sound',
        soundDesc: 'Audio feedback on count',
        digital: 'Digital',
        beads: 'Beads',
        none: 'None',
        vibration: 'Vibration',
        ...
        keepAwakeDesc: 'Prevent screen from sleeping',
        autoReset: 'Auto-reset on Target',
        autoResetDesc: 'Reset when target is reached',
        data: 'Data',
        importData: 'Import Data',
        importDataDesc: 'Restore from JSON file',
        clearAllData: 'Clear All Data',
        clearDataDesc: 'Delete all history and settings',
        ...
        autoResetToast: 'Auto-reset applied',
        ...
        confirmReset: 'Reset counter to 0?',
        noSessions: 'No sessions yet',
        noSessionsDesc: 'Start counting to see your history'
    },
    ar: {
        appTitle: 'مسبحة برو',
        splashSubtitle: 'رفيق الأذكار الرقمي',
        selectDhikr: 'اختر الذكر',
        tapToStart: 'اضغط الزر أدناه للبدء',
        tapToCount: 'اضغط للعد',
        undo: 'تراجع',
        reset: 'إعادة',
        save: 'حفظ',
        dhikrLibrary: 'مكتبة الأذكار',
        chooseDhikr: 'اختر ذكراً لبدء جلستك',
        statistics: 'الإحصائيات',
        trackProgress: 'تتبع تقدمك الروحي',
        today: 'اليوم',
        ...
        counter: 'المسبحة',
        sound: 'الصوت',
        soundDesc: 'التغذية الراجعة الصوتية',
        digital: 'رقمي',
        beads: 'خرز',
        none: 'بدون',
        vibration: 'الاهتزاز',
        vibrationDesc: 'التغذية الراجعة اللمسية',
        keepAwake: 'إبقاء الشاشة مفتوحة',
        keepAwakeDesc: 'منع الشاشة من الإغلاق',
        autoReset: 'إعادة ضبط تلقائي',
        autoResetDesc: 'إعادة الضبط عند الوصول للهدف',
        data: 'البيانات',
        importData: 'استيراد البيانات',
        importDataDesc: 'استعادة من ملف JSON',
        clearAllData: 'مسح جميع البيانات',
        clearDataDesc: 'حذف السجل والإعدادات',
        ...
        autoResetToast: 'تمت إعادة الضبط',
        sessionSaved: 'تم حفظ الجلسة',
        counterReset: 'تم إعادة الضبط',
        ...
        confirmReset: 'إعادة ضبط العداد إلى صفر؟',
        noSessions: 'لا توجد جلسات بعد',
        noSessionsDesc: 'ابدأ العد لرؤية سجلك'
    },
    ha: {
        appTitle: 'Tasbeeh Pro',
        splashSubtitle: 'Abokin Dhikr na Dijital',
        selectDhikr: 'Zaabi Dhikr',
        tapToStart: 'Danna maɓallin don farawa',
        tapToCount: 'DANNA DON ƘIDDA',
        undo: 'Juya baya',
        reset: 'Sake saita',
        save: 'Ajiye',
        dhikrLibrary: 'Laburaren Dhikr',
        chooseDhikr: 'Zaabi dhikr don fara zamananka',
        statistics: 'Tashe',
        trackProgress: 'Bi tashen ruhaninka',
        today: 'Yau',
        thisWeek: 'Wannan Makon',
        streak: 'Tsawon Lokaci',
        total: 'Jimla',
        weeklyActivity: 'Ayyukan Makonni',
        recentSessions: 'Zamaman Kwanan nan',
        exportData: 'Fitar da Bayanai',
        settings: 'Saituna',
        customize: 'Saita yadda kake so',
        appearance: 'Fuska',
        theme: 'Jigo',
        themeDesc: 'Zaabi yanayin da kake so',
        dark: 'Duhu',
        light: 'Haske',
        system: 'Na tsarin',
        language: 'Harshe',
        languageDesc: 'Zaabi harshen da kake so',
        counter: 'Lissafi',
        sound: 'Sauti',
        soundDesc: 'Sautin martani',
        digital: 'Na dijital',
        beads: 'Zubin',
        none: 'Babu',
        vibration: 'Girgiza',
        vibrationDesc: 'Martani na taɓawa',
        keepAwake: 'Bar Allon a Buɗe',
        keepAwakeDesc: 'Hana allon ya yi barci',
        autoReset: 'Sake Saita Kai-tsaye',
        autoResetDesc: 'Sake saita idan aka kai burin',
        data: 'Bayanai',
        importData: 'Shigo da Bayanai',
        importDataDesc: 'Dawo da bayanai daga fayil',
        clearAllData: 'Share Duk Bayanai',
        clearDataDesc: 'Share tarihi da saituna',
        aboutText: 'An yi shi da ƙauna ga al\'umma. Allah ya karɓi addu\'o\'inku.',
        navCounter: 'Lissafi',
        navDhikr: 'Dhikr',
        navStats: 'Tashe',
        navSettings: 'Saituna',
        setTarget: 'Saita Burin',
        apply: 'Aiwatar',
        cancel: 'Soke',
        targetReached: 'An kai burin! 🎯',
        autoResetToast: 'An sake saita kai-tsaye',
        sessionSaved: 'An ajiye zaman',
        counterReset: 'An sake saita lissafi',
        nothingToSave: 'Babu abin da za a ajiye',
        dataExported: 'An fitar da bayanai',
        dataImported: 'An shigo da bayanai',
        dataCleared: 'An share duk bayanai',
        confirmClear: 'Ka tabbata? Wannan zai share duk bayananka.',
        confirmReset: 'Sake saita lissafi zuwa sifili?',
        noSessions: 'Babu zamani tukuna',
...
class AudioEngine {
    ...
    play(type) {
        ...
        switch (type) {
            case 'digital': this.playDigital(); break;
            case 'beads': this.playBeads(); break;
        }
    }
...
class StatsManager {
    ...
    static getTodayCount(data) {
        return data.history[this.getTodayKey()] || 0;
    }
...
class TasbeehApp {
    ...
    setupEventListeners() {
        ...
        document.querySelectorAll('.target-preset').forEach(btn => {
            btn.addEventListener('click', () => {
                document.getElementById('targetInput').value = btn.dataset.value;
            });
        });
        ...
        document.addEventListener('visibilitychange', () => {
            if (!document.hidden && this.data.settings.keepAwake) {
                this.setupWakeLock();
            }
        });
    }
    ...
    handleCount(e) {
        ...
        // Vibration
        if (this.data.settings.vibration && navigator.vibrate) {
    ...
    handleSaveSession() {
        const session = this.data.currentSession;
        if (session.count === 0) {
            this.showToast(I18n.t('nothingToSave'));
            return;
        }
    ...
    exportData() {
        Storage.export();
        this.showToast(I18n.t('dataExported'));
    }
    ...
    async importData(file) {
        ...
        try {
            ...
            this.showToast('Error: Invalid file');
        }
...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('sw.js').catch(() => {
        // Silent fail for local file:// usage
    });
}
